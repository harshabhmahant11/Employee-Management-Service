...
<html>
	...
	<body>
		...
		<h3 style="display: inline-block; text-align: left; margin : 15px;">Delete Employee Details</h2>
		
		<div class="container cstm-card">
			<form action="removeEmployeeDetails" onSubmit="return confirm('Do you wish to delete this employee\'s details? This action is not reversible.')" method="post">
